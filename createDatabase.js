...
"groupreadaccessall": {
      "map": function(doc) {  if( doc.groupreadaccess ) {for( var i=0, l=doc.groupreadaccess.length; i<l; i++) {emit(doc.groupreadaccess[i], doc );}}
	  }.toString()
        },
...
"groupwriteaccessall": {
      "map": function(doc) {  if( doc.groupwriteaccess ) {for( var i=0, l=doc.groupwriteaccess.length; i<l; i++) {emit(doc.groupwriteaccess[i], doc );}}
	  }.toString()
        },
...
var testDesign1 = function(cb) {
  request( serverAddress + '/_design/gibbertest/_view/groupreadaccessall?key="group1"', function(e,r,b) {
...
var testDesign7 = function(cb) {
  request( serverAddress + '/_design/gibbertest/_view/groupwriteaccessfile?key="group1"', function(e,r,b) {
    console.log( "TESTING DESIGN:", b )
    if( cb ) cb()
  })
}
